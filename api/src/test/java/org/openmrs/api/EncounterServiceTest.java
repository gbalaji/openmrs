...
public class EncounterServiceTest extends BaseContextSensitiveTest {
	...
	public void getEncounters_shouldGetAllTheEncountersWithTheGivenFormAndLocationId()
		...
		List<Encounter> encountersPage1 = encounterService.getEncounters(formService.getForm(1), locService.getLocation(1), 2, 1);
		assertEquals(2, encountersPage1.size());
		
		List<Encounter> encountersPage2 = encounterService.getEncounters(formService.getForm(1), locService.getLocation(1), 2, 2);
		assertEquals(2, encountersPage2.size());

		List<Encounter> encountersPage3 = encounterService.getEncounters(formService.getForm(1), locService.getLocation(1), 2, 3);
	...
	public void getEncounters_shouldGetAllTheEncountersWithTheGivenFormAndLocationIdForGivenPageAndPageSizeWithEncounterDateAndDateCreatedInAscOrder()
		...
		List<Encounter> encountersPage1 = encounterService.getEncounters(formService.getForm(1), locService.getLocation(1), 5, 1);
	...
	public void getEncounterCount_shouldGetTotalEncounterCountWithTheGivenFormAndLocationId()
		...
		FormService formService = Context.getFormService();
		LocationService locService = Context.getLocationService();
		Integer encounterCount = encounterService.getEncounterCount(formService.getForm(1), locService.getLocation(1));
